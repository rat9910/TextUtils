...
export default function Inputtext(props) {
  ...
  const formatHTML = () => {
    // Remove new lines and extra spaces between tags, and replace " with '
    let newText = text.replace(/\n\s*/g, " ").replace(/"/g, "'").trim();
    setText(newText);
    console.log(newText);

    props.showAlert("Convert Into Richtext", "success");
  };
  ...
  const toCamelCase = () => {
    let newText = text
      ...
      .join("");
    setText(newText);
    props.showAlert("Convert Into to Camel Case", "success");
  };
